...
if ENVIRONMENT == 'production':
    ...
    print("Redis Cluster Master Hosts: ", REDIS_CLUSTER_HOST1, REDIS_CLUSTER_HOST2, REDIS_CLUSTER_HOST3, flush=True)
    print("Redis Cluster Port: ", REDIS_CLUSTER_PORT, flush=True)
...
PRESIGNED_URL_EXPIRY_TIME = 3600 * 24  # 1 Day

SEGMENT_ACTIVITY_EXPIRY = 3600 * 3  # 3 hours
CACHED_SEGMENT_EXPIRY = 3600 * 3  # 3 hours
