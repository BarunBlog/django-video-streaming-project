...
REDIS_CLUSTER_NODES = [
    ClusterNode(REDIS_CLUSTER_HOST1, int(REDIS_CLUSTER_PORT)),
    ClusterNode(REDIS_CLUSTER_HOST2, int(REDIS_CLUSTER_PORT)),
    ClusterNode(REDIS_CLUSTER_HOST3, int(REDIS_CLUSTER_PORT)),
    ClusterNode(REDIS_CLUSTER_HOST4, int(REDIS_CLUSTER_PORT)),
    ClusterNode(REDIS_CLUSTER_HOST5, int(REDIS_CLUSTER_PORT)),
    ClusterNode(REDIS_CLUSTER_HOST6, int(REDIS_CLUSTER_PORT)),
]
